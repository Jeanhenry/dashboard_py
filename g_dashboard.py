...
#print(df_casos["REGIAO"].value_counts().index)
    ...
    children=[
            ...
            [
                dbc.Col(
                    html.Div(
                        [html.Img(
                            id="logo"
                            , src=app.get_asset_url("henry_analytics2.1.png")
                            , height=50),],style={"background-color": "#1E1E1E"
                                                    ,"margin": "-25px"
                                                    ,"padding": "25px"}), md=4),
        ...
        dbc.Row(
            [
                ...
                # CheckList ( REGIAO )
                html.P("Selecione a Região desejada:", style={"margin-top": "40px"}),
                dcc.Checklist(df_casos["REGIAO"].value_counts().index,
                df_casos["REGIAO"].value_counts().index, id = "check_regiao" ),
